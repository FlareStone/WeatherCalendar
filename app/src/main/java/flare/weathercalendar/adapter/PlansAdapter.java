...
public class PlansAdapter extends BaseAdapter {
    ...
    public PlansAdapter(Context context, List<Plan> data) {
        this.data = data;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.plan, null);
        ...
        holder.dateTime.setText(plan.getYear() + "年" + plan.getMonth() + "月" + plan.getDay()
                + "日\n" + AddPlanActivity.getTime(plan.getHour(), plan.getMinute()));
